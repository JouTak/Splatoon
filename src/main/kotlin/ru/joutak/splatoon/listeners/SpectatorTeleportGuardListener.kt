...
/**
 * Prevents Splatoon spectators from using the vanilla SPECTATOR hotbar teleport to leave the match world.
 * Without this, a spectator can jump to players in other Multiverse worlds (including lobby), which is unsafe.
 */
class SpectatorTeleportGuardListener : Listener {
